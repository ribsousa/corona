  ...
  methods: {
    chartData () {
      const dataCollection = {
        labels: ['Cases', 'Suspects', 'Refuses', 'Deaths'],
        datasets: this.fillState()
      }
    ...
    exportPdf () {
      ...
      const doc = new JsPdf()
      doc.setFontSize(10)
      doc.text(10, 25, ` Comparision chart between states (Covid19) - ${this.$options.filters.moment(new Date(), 'YYYY/MM/DD HH:mm:ss')}`)
